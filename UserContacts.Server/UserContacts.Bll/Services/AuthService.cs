...
public class AuthService : IAuthService
{
    ...
    public AuthService(IUserService userService, ITokenService tokenService, JwtAppSettings jwtAppSettings, IRefreshTokenService refreshTokenService, IUserRoleService roleService, IMapper mapper)
    {
